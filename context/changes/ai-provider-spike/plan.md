...
- [x] 3.1 `wrangler deploy --dry-run` passes, compressed Worker bundle well under 1 MB — 88ab79d

#### Manual

- [x] 3.2 Real phone photo (JPEG/PNG/WebP) identified end-to-end through the test page — 88ab79d
- [x] 3.3 "Not recognised" path observed on a non-landmark photo — 88ab79d
- [x] 3.4 Rate limit `429` observed at count = 100 — 88ab79d
- [x] 3.5 Free-tier CPU adequate for the relay (no CPU-limit errors) — 88ab79d
- [x] 3.6 F-02 success criteria in `research.md` checked off — 88ab79d
