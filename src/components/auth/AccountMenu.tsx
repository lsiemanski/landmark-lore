    ...
    <>
      <div ref={menuRef} className="relative">
        <button
          ...
          className="flex cursor-pointer items-center gap-1.5 rounded-lg px-2 py-1.5 text-sm text-blue-100/60 transition-colors hover:bg-white/10 hover:text-blue-100"
        >
        ...
        {open && (
          <div className="absolute right-0 mt-1 w-44 rounded-xl border border-white/10 bg-[#0f1117] py-1 shadow-xl">
            <button
              ...
              className="flex w-full cursor-pointer items-center gap-2.5 px-3 py-2 text-sm text-white/70 transition-colors hover:bg-white/10 hover:text-white"
            >
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center gap-2.5 px-3 py-2 text-sm text-red-400/70 transition-colors hover:bg-white/10 hover:text-red-400"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              ...
              className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              <Trash2 className="size-4" />
